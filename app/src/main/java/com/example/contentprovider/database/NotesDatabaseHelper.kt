...
class NotesDatabaseHelper(context:Context): SQLiteOpenHelper(context,"databaseNotes",null,1) {
    ...
    companion object {
        const val TABLE_NOTES: String = "Notes" // Nome da tabela
        const val TITLE_NOTES: String = "title" // Uma das colunas do banco
        const val DESCRIPTION_NOTES: String = "description" // As notas propriamente ditas
    }
}