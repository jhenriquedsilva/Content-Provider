...
class NotesDetailFragment: DialogFragment(),DialogInterface.OnClickListener {
    ...
    private lateinit var noteEditDescripition: EditText
    ...
    companion object {
        ...
        fun newInstance(id: Long): NotesDetailFragment {
            ...
            var notesFragment = NotesDetailFragment()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        noteEditTitle = view.findViewById(R.id.note_edt_description) as EditText
        ...
        if (arguments != null && arguments?.getLong(EXTRA_ID) != 0L) {
            ...
            if (cursor?.moveToNext() as Boolean) {
                ...
                noteEditDescripition.setText(cursor.getString(cursor.getColumnIndex(DESCRIPTION_NOTES)))
            }
            cursor.close()
        }
    ...
    override fun onClick(dialog: DialogInterface?, which: Int) {
        ...
        values.put(DESCRIPTION_NOTES,noteEditDescripition.text.toString())
